...
def normalize_metadata(data: dict, report: NormalizationReport, testcase_id: str) -> dict:
    ...
    for key in ["uitgangspunten", "opmerkingen", "data_kwaliteit", "bron", "_incomplete", "regressies_vermogen", "regressies_netto", "regressies_scenariokaarten", "regressies_opbouw", "regressies_actuarieel"]:
        if key in metadata:
