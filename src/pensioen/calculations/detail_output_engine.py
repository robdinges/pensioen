...
def bouw_accountant_detail(
        ...
        vermogen_rijen.append(
            {
                ...
                "inleg": maand_inleg,
                "saldo_correctie": maand.vermogen_correctie,
    ...
    detail = {
        ...
        "box3_grondslag": _d(box3_payload.get("grondslag_start_vermogen")),
        "box3_grondslag_liquide": _d(box3_payload.get("grondslag_liquide_deel")),
        "box3_grondslag_vaste_items": _d(box3_payload.get("grondslag_vaste_items")),
        "box3_grondslag_bron": box3_payload.get("grondslag_bron", "geen"),
        "rendement_grondslag_start": _d(box3_payload.get("rendement_grondslag_start")),
        ...
        "jaar_vermogen_correctie": _som_maanden(maanden, lambda m: m.vermogen_correctie),
        "rendement_bron": "vermogensitems" if per_post else "legacy_scenario",
